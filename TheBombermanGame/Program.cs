    ...
    public static List<string> bomberMan(int n, List<string> grid)
    {
        ...
        {   
            for (int l = 0; l < lin; l++) //cycle through lines
            {
                ...
                {
                    if (grid[l].Substring(c,1) == "0") //finds bomb
                    {
                        //PREVIOUS LINE (l-1)
                        ...
                        if (l > 0) //if not the first line
                        {
                            string pLeft = "", pRight = "";
                                        //1 away from border
                            if (c > 0) { pLeft = fullgrid[l-1].Substring(0, c - 1); }
                        ...
                        string left="", right="", center;
                                        //2 away from border
                        if (c > 1)          { left = fullgrid[l].Substring(0, c - 2); }
                        ...
                        if (l < lin-1) //if not the last line
                        {
                            string nLeft = "", nRight = "";
                                                //1 away from border
                            if (c > 0)      { nLeft = fullgrid[l+1].Substring(0, c - 1); }
